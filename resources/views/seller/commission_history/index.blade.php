...
@section('panel_content')
    @if(get_setting('vendor_commission_activation') == 1)
        <div class="aiz-titlebar text-left mt-2 mb-3">
            ...
            <p class="font-weight-bold my-1">{{ translate('You are under Category Wise commission. See the commission details ') }} <a class="text-info ml-1" href="{{ route('seller.categories-wise-commission') }}" wire:navigate>{{ translate('Here') }}</a></p>
            @endif
            </div>
