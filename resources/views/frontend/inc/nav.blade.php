    ...
    <!-- Top Bar -->
    <div class="top-navbar bg-white z-1035 h-35px h-sm-auto d-none d-lg-block">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 text-right d-none d-lg-block">
                    <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                        ...
                        <li class="list-inline-item dropdown py-2">
                            <a class="text-secondary fs-12 dropdown-toggle d-inline-block border-width-2 border-right pr-3"
                                href="#" role="button" id="affDropdown" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="fas fa-chevron-down"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right py-0" aria-labelledby="affDropdown">
                                <a class="dropdown-item"
                                    href="{{ route('affiliate.apply') }}">{{ translate('Become an Affiliate') }}</a>
                            </div>
                        </li>
                        @endif
                        ...
                        class="text-secondary fs-12 pr-3 d-inline-block border-width-2
                        border-right">{{ translate('Become a Seller !') }}</a>
                        </li> --}}
                        <!-- Seller Login -->
                        <li class="list-inline-item mr-0 pl-0 py-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg py-0 rounded-0">
                                ...
                                <div class="c-scrollbar-light overflow-auto" style="max-height:300px;">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        @php
                                        $isLinkable = true;
                                        $notificationType = get_notification_type($notification->notification_type_id,
                                        'id');
                                        $notifyContent = $notificationType->getTranslation('default_text');
                                        $notificationShowDesign = get_setting('notification_show_type');
                                        if($notification->type == 'App\Notifications\customNotification' &&
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    $route = route('purchase_history.details',
                                                    encrypt($notification->data['order_id']));
                                                    $orderCode = "<span class='text-blue'>".$orderCode."</span>";
                                                    $notifyContent = str_replace('[[order_code]]', $orderCode,
                                                    $notifyContent);
                                                    @endphp
                                                    ...
                                                    @php
                                                    $orderCode = $notification->data['order_code'];
                                                    $route = route('preorder.order_details',
                                                    ...
                                                    <a
                                                        ...
                                                        @endif
                                                        <span class="fs-12 text-dark text-truncate-2">{!! $notifyContent
                                                            !!}</span>
                                                        @if($isLinkable = true)
                                                    </a>
                                                    @endif
