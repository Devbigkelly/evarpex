...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $todays_deal_products = filter_products(Product::where('todays_deal', 1))->orderBy('id', 'desc')->limit(10)->get();
      $categories = Category::with('childrenCategories')->get();



        return view('frontend.' . get_setting('homepage_select') . '.index', compact('featured_categories','newest_products','featured_products','todays_deal_products','categories'));
    }
