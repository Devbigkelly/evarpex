                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img src="{{ asset('asset/img/39.jpg')}}" alt="{{ translate('Customer Register Page Image') }}" class="img-fit h-100">
                            </div>
                                        ...
                                        @endif
                                            ...
                                            <div class="mb-3">
                                                <label class="aiz-checkbox">
                                                    ...
                                                    <span class="">{{ translate('By signing up you agree to our ')}} <a href="{{ route('terms') }}" wire:navigate class="fw-500">{{ translate('terms and conditions.') }}</a></span>
