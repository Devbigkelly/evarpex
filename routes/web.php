...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/pages/sellers', 'sellers')->name('sellers.home');
    Route::get('/pages/about-us', 'about')->name('about');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    // Purchase History
    Route::resource('order-history', PurchaseHistoryController::class);
    Route::controller(PurchaseHistoryController::class)->group(function () {
        Route::get('/order-history/details/{id}', 'purchase_history_details')->name('purchase_history.details');
        Route::get('/order-history/destroy/{id}', 'order_cancel')->name('purchase_history.destroy');
