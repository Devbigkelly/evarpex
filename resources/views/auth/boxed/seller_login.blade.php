                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img src="{{ asset('asset/img/39.jpg')}}" alt="{{ translate('Seller Login Page Image') }}" class="img-fit h-100">
                            </div>
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                                ...
                                <div class="pt-3">
                                        ...
                                        <form class="form-default" id="seller-login-form" role="form" action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-6 text-right">
                                                    <a href="{{ route('password.request') }}" wire:navigate class="text-reset fs-12 fw-400 text-gray-dark hov-text-primary"><u>{{ translate('Forgot password?')}}</u></a>
                                                </div>
                                            </div>

                                            <!-- Submit Button -->
                                            <div class="mb-4 mt-4">
                                                <button type="submit"  onclick="this.disabled=true; this.form.submit();" class="btn btn-primary btn-block fw-700 fs-14 rounded-0">{{  translate('Login') }}</button>
                                            </div>
                                        </form>
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a href="{{ route(get_setting('seller_registration_verify') === '1' ? 'shop-reg.verification' : 'shops.create') }}" wire:navigate class="ml-2 fs-14 fw-700 animate-underline-primary">{{ translate('Register Now')}}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
