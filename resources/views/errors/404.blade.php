        ...
        <div class="row row-cols-1 row-cols-md-3 g-3 g-lg-4">
          <div class="col">
            <div class="nav flex-column position-relative h-100 border rounded-5 p-4 pt-3">
              <a class="nav-link animate-underline stretched-link text-body-emphasis fw-semibold px-0 mb-1" href="{{ route('home')}}" wire:navigate>
          ...
          <div class="col">
            <div class="nav flex-column position-relative h-100 border rounded-5 p-4 pt-3">
              <a class="nav-link animate-underline stretched-link text-body-emphasis fw-semibold px-0 mb-1" href="#">
