                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img src="{{ asset('asset/img/39.jpg')}}" alt="{{ translate('Customer Login Page Image') }}" class="img-fit h-100">
                            </div>
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                                ...
                                <div class="text-center text-lg-left">
                                    <h1 class="fs-20 fs-md-24 fw-700" style="text-transform: uppercase;">{{ translate('Welcome Back !')}}</h1>
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form class="form-default loginForm" id="user-login-form"role="form" action="{{ route('login') }}" method="POST">
                                            ...
                                            <!-- Submit Button -->
                                            <div class="mb-4 mt-4">
                                                <button type="submit"   onclick="this.disabled=true; this.form.submit();" class="btn btn-primary btn-block fw-700 fs-14 rounded-0 submit-button" style="
...
">{{  translate('Login') }}</button>
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a href="{{ route(get_setting('customer_registration_verify') === '1' ? 'registration.verification' : 'user.registration') }}" wire:navigate class="ml-2 fs-14 fw-700 " style="
