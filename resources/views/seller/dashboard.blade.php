                                    ...
                                    <h6 class="text-primary">
                                        ...
                                        <div class="">
                                            <a href="{{ route('seller.seller_packages_list') }}"
                                                class="btn btn-soft-primary" wire:navigate>{{ translate('Upgrade Package') }}</a>
                                        </div>
                                </div>
                            </div>
                        @else
                ...
                @if ($authUser->shop?->verification_status == 0)
                    <div class="my-n4 py-1 text-center">
                        ...
                        <a href="{{ route('seller.shop.verify') }}"
                            class="btn btn-sm btn-primary" wire:navigate>{{ translate('Verify Now') }}</a>
                    </div>
                @else
                    <div class="my-2 py-1">
      ...
      @if(get_setting('vendor_commission_activation') == 1)
                        ...
                        <ul class="list-group">
                            ...
                            <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                             {{ translate('You are Under Category Wise Commission Rate ') }}
                                <span class="">
                                    <a class="btn btn-primary btn-xs " href="{{ route('seller.categories-wise-commission') }}" wire:navigate>{{ translate('Details') }}</a>
                                </span>
                            </li>
                            @endif
                        </ul>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="{{ route('seller.money_withdraw_requests.index') }}"
                class="card mb-4 p-4 text-center bg-soft-primary h-180px" wire:navigate>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                ...
                <a href="{{ route('seller.shop.index') }}" class="btn btn-primary" wire:navigate>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                ...
                <a href="{{ route('seller.profile.index') }}" class="btn btn-primary" wire:navigate>
                            ...
                            <div class="position-relative">
                                <a href="{{ route('product', $product->slug) }}" class="d-block">
                                    <img class="img-fit lazyload mx-auto h-210px"
                                        ...
                                        onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" wire:navigate>
                                </a>
                            </div>
                            <div class="p-md-3 p-2 text-left">
                                ...
                                <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                    <a href="{{ route('product', $product->slug) }}"
                                        class="d-block text-reset" wire:navigate>{{ $product->getTranslation('name') }}</a>
                                </h3>
                            </div>
                        </div>
                    </div>
